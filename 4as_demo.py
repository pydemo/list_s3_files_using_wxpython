...
from _Sortable_ListPanel import _Sortable_ListPanel
        
from pipeline.s3.view.module.list_s3_objects_sortable_paginated_sqlite.Sortable_ListPanel import Sortable_ListPanel

class TestFrame(wx.Frame):
    def __init__(self, parent=None):
        super(TestFrame, self).__init__(parent)
        vbox = wx.BoxSizer(wx.VERTICAL)
        panel0=_Sortable_ListPanel(self)
        
        panel=Sortable_ListPanel(parent=self)
        if 0:
